...
public class OnSwipeListener implements View.OnTouchListener {
    ...
    private final class SwipeGestureListener
        ...
        private static final int MIN_SWIPE_DISTANCE = 100; // мінімальнa відстань
        private static final int MIN_SWIPE_VELOCITY = 100; // мінімальнa швидкість руху
        ...
        public boolean onFling(@NonNull MotionEvent e1, @NonNull MotionEvent e2, float velocityX, float velocityY) {
            ...
            // оброблена, інакше false, що свідчить про потребу передавати подію
            // іншим обробникам
...
Пристрої з сенсорним екраном мають ряд особливостей у контексті подій від User Interface
